...
//
// flexapi HTTP server encoders and decoders
//
// Command:
...
// EncodeAddResponse returns an encoder for responses returned by the flexapi
// add endpoint.
...
// DecodeAddRequest returns a decoder for requests sent to the flexapi add
// endpoint.
